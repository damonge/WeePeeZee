...
\flushbottom
  ...
  \section{Introduction}\label{sec:intro}\label{sec:intro}
    ...
    We apply this method to the HSC first public data release as an example, and discuss some of the advantages, limitations and possible extensions of this model.

    \da{The paper is structured as follows...}
  ...
  \section{Appplication to galaxy clustering in HSC}\label{sec:hsc}
    ...
    \subsection{Validating the linear expansion}\label{ssec:hsc.lin}
      ...
      \bh{It is a Gaussian draw from the inverted smoothing prior multiplied by 0.6, see this code line \url{https://github.com/damonge/WeePeeZee/blob/ce50049c6be90ca40b3a903ba782d8bff4b46c78/create_sacc.py##L246}, and \\ $\mathbf{calculate\_smooth\_s\_and\_prior.py}$ for details on the smoothing prior but it should be same as the equation being referenced}.
