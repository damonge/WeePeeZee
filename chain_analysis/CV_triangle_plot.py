...
CV_hsc = MCSamples(samples=CV_chains,names=par_names,labels=lab_names,name_tag='CV')
...
g.triangle_plot([fiducial_hsc,CV_hsc,marg_hsc],params=HOD_pars,legend_labels=[lab_fid,lab_CV,lab_marg],filled=True)
